    ...
    namespace POMDP {
        ...
        class ProjecterGeneral<M> {
            public:
                 ...
                 */
                ProjecterGeneral(const M & model);
        ...
        template <typename M>
        typename ProjecterGeneral<M>::ProjectionsTable ProjecterGeneral<M>::operator()(const VList & w) {
        ...
        template <typename M>
        void ProjecterGeneral<M>::computeImmediateRewards() {
        ...
        template <typename M>
        void ProjecterGeneral<M>::computePossibleObservations() {
            for ( size_t a = 0; a < A; ++a )
                for ( size_t o = 0; o < O; ++o )

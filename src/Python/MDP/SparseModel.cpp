...
void exportMDPSparseModel() {
    ...
    class_<SparseModel>{"SparseModel",
        ...
        .def("setDiscount",                 &SparseModel::setDiscount,
                "This function sets a new discount factor for the SparseModel."
        , (arg("self"), "discount"))

        .def("setTransitionFunction",       &SparseModel::setTransitionFunction<std::vector<std::vector<std::vector<double>>>>,
        ...
        .def("setRewardFunction",           &SparseModel::setRewardFunction<std::vector<std::vector<std::vector<double>>>>,
        ...
        .def("getTransitionProbability",    &SparseModel::getTransitionProbability,
                "This function returns the stored transition probability for the specified transition."
        , (arg("self"), "s", "a", "s1"))

        .def("getExpectedReward",           &SparseModel::getExpectedReward,
